...
import com.sample.db.model.Permission;
import com.sample.db.model.PermissionExample;
...
public interface PermissionMapper {
	...
	@Insert({
			...
			"#{url,jdbcType=VARCHAR}, #{type,jdbcType=TINYINT}, #{describe,jdbcType=VARCHAR}, ",
	...
	@Select({
			"select",
			"id, parentId, name, url, type, describe, weight, status, createTime, updateTime",
